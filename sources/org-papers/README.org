...
For general Org-mode documentation, please refer to [[http://orgmode.org/org-mode-documentation.html][Org-Mode: Documentation]].

* Papers About Org-mode

- Dominik C., [[http://www.network-theory.co.uk/org/manual/][/The
  Org-Mode 7 Reference Manual: Organize Your Life with GNU
  Emacs/]]. Network Theory,
  UK, 2010. ([[file:org-contrib/bibtex/Dominik2010.bib][bibtex]])
...
- [[http://orgmode.org/worg/org-contrib/babel/uses.html#sec-6][Reproducible
